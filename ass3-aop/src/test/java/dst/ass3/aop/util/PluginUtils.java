...
import dst.ass3.aop.event.EventBusHandler;
...
public final class PluginUtils {
	 ...
	 *
	 * @throws IOException
	 *             if the destination file already exists or the file was not
	 *             copied
	 * @see #uniqueFile()
	 */
	 ...
	 *            the plugin class
	 * @param aspectClass
	 *            the class containing AspectJ definitions
	 ...
	 *
	 * @param advised
	 *            the proxy with the applied aspect
	 ...
	 * @param advised
	 *            the proxy with the applied aspect
	 * @return the pointcut advisor or {@code null} if there is no AspectJ
	 *         pointcut advisor applied
	 */
